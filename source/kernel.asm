	...
	%DEFINE OS_VER '1.0'	; OS version number
...
; use a SwordFish  system call without having to know its exact position
...
os_main:
	...
	mov es, ax			; segments ever again, as SwordFish os and its programs
...
option_screen:
	...
	os_init_msg		db 'Welcome to SwordFish OS', 0
	os_version_msg		db 'Version ', OS_VER, 0

	dialog_string_1		db 'Thanks for trying out SwordFish OS!', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'Cannot load and execute SwordFish OS kernel!', 0
	kerndlg_string_2	db 'KERNEL.BIN is the core of SwordFish OSOS, and', 0
